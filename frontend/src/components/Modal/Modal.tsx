                    ...
                    !this.props.noFooter ? (
                        ...
                        >
                            {this.props.discardButtonProps && (
                                <Button
                                    className={
                                        this.props.discardButtonProps.className
                                    }
                                    disabled={
                                        this.props.discardButtonProps.disabled
                                    }
                                    waiting={
                                        this.props.discardButtonProps.waiting
                                    }
                                    canTriggerByEnter={
                                        this.props.discardButtonProps
                                            .canTriggerByEnter
                            ...
                            {this.props.submitButtonProps && (
                                <Button
                                    className={
                                        this.props.submitButtonProps.className
                                    }
                                    disabled={
                                        this.props.submitButtonProps.disabled
                                    }
                                    waiting={
                                        this.props.submitButtonProps.waiting
                                    }
                                    canTriggerByEnter={
                                        this.props.submitButtonProps
                                            .canTriggerByEnter
