...
class TradeVolumeBarChart extends React.Component<Props, State> {
    public state: State;
        ...
        return (
            ...
            this.props.data.length > 1 && (
                <Chart
                    ...
                    data={
                        Util.isMobile
                            ? this.cashInvestedChartDataMobile
                            : this.props.data
                    }
                    chartPackages={
                        !Util.isMobile
    ...
    private get controlStartDate(): Date {
        return new Date(
            Math.min(
                ...this.props.tradeRecords.map((record) =>
...
export default connect(mapStateToProps)(TradeVolumeBarChart);
