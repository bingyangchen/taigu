...
export default class Welcome extends React.Component<Props, State> {
            ...
            this.setState({
                demoImageToShow: Math.min(
                    ...
                    Math.max(
                        0,
                        Math.floor(
                            (mainDiv.scrollTop * 2) / mainDiv.clientHeight
                        ) - 2
                    )
                ),
                captionToShow: Math.min(
                    ...
                    Math.max(
                        0,
                        Math.floor(mainDiv.scrollTop / mainDiv.clientHeight) - 1
                    )
                ),
                ballScale: this.getBallScale(
                    Math.min(
                        3.3,
                        Math.max(0, mainDiv.scrollTop - 200) /
            ...
            <main ref={this.mainRef} className={styles.main}>
                {Util.isMobile ? (
                    ...
                    <div className={styles.cta_container}>
                        ...
                        <div className={styles.middle}>
                            <div className={styles.top}>TradeSmartly</div>
                ...
                <div className={`${styles.slide} ${styles.one}`}>
                    <h1 className={styles.title}>
                        TradeSmartly helps you trade smartly.
                    </h1>
                ...
                <div className={`${styles.slide} ${styles.two}`}>
                        ...
                        <div className={styles.inner}>
                            <div className={styles.iphone}>
                                <img
                                    src={demo01}
                                    alt=""
                                    className={this.getDemoImageClass(0)}
                                />
                                <img
                                    src={demo02}
                                    alt=""
                                    className={this.getDemoImageClass(1)}
                                />
                                <img
                                    src={demo03}
                                    alt=""
                                    className={this.getDemoImageClass(2)}
                                />
                                <img
                                    src={demo04}
                                    alt=""
                                    className={this.getDemoImageClass(3)}
                                />
                                <img
                                    src={demo05}
                                    alt=""
                                    className={this.getDemoImageClass(4)}
                                />
                                <img
                                    src={demo06}
                                    alt=""
                                    className={this.getDemoImageClass(5)}
                                />
                            </div>
                    ...
                    <div className={styles.right}>
                        <div className={styles.inner}>
                            <div className={this.getCaptionClass(0)}>
                                介面簡潔乾淨
                            </div>
                            <div className={this.getCaptionClass(1)}>
                                圖表一目了然
                            </div>
                            <div className={this.getCaptionClass(2)}>
                                操作近乎直覺
                            </div>
                        </div>
                    </div>
                ...
                <footer className={styles.footer}>
                    ...
                    <div className={styles.copyright}>
                        Copyright © TradeSmartly 2021-{new Date().getFullYear()}{" "}
                        All rights reserved
                    </div>
                </footer>
            </main>
    ...
    private bluntCosine(cos: number, b: number): number {
        ...
        return (
            cos *
            Math.sqrt(
                (1 + Math.pow(b, 2)) / (1 + Math.pow(b, 2) * Math.pow(cos, 2))
            )
        );
    }
}
