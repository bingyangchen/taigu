        ...
        return (
            <div className={styles.main}>
                ...
                <div className={styles.body}>
                    <div className={styles.effective_date}>
                        生效日期：2024 年 1 月 1 日
                    </div>
                    <h2>適用範圍</h2>
                    <p>
                        本隱私權政策適用於您在 TradeSmartly
                    ...
                    <p>
                        ...
                        <ul>
                            ...
                            <li>
                                您在本網站使用第三方服務時所提供的資料，例如：您使用
                                Google 登入本網站時所提供的 Google 帳號資料。
                            </li>
                        </ul>
                    </p>
                    <h2>個人資料之使用</h2>
                    ...
                    <p>
                        ...
                        <ul>
                            <li>
                                使用防火牆、入侵偵測系統等技術措施，防止未經授權的存取。
                            </li>
                            <li>
                                使用加密技術，確保您的個人資料傳輸的安全性。
                            </li>
                            <li>限制存取您的個人資料的人員。</li>
