...
class Records extends React.Component<Props, State> {
            ...
            <div className={styles.main}>
                ...
                <div className={styles.switch_button_container}>
                    ...
                    <Button
                        ...
                        onClick={() =>
                            this.handleClickSwitchButton("cashDividend")
                        }
                    >
                        現金股利
                    </Button>
                ...
                <div className={styles.record_list}>
                    {this.filteredRecords
                        ...
                        .map(
                            (record: TradeRecord | CashDividendRecord, idx) => {
    ...
    private getSwitchButtonClass(name: "trade" | "cashDividend"): string {
        return this.state.activeSubpageName === name
            ? "white xs"
            : "transparent xs";
    }
    private handleClickSwitchButton = (
        name: "trade" | "cashDividend"
    ): void => {
