    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', models.BigIntegerField()),
                ('close_price', models.FloatField()),
                ('company', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='history', to='stock.company')),
            ],
            options={
                'db_table': 'history',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, related_name='material_facts', to='stock.company')),
            ],
            options={
